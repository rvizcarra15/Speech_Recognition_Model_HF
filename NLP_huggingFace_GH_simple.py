# -*- coding: utf-8 -*-
"""
Created on Sat Apr  6 18:36:39 2024
...
#***************STEP-03: TRANSLATION MODEL-SIMPLE LIMIT OF 512 *******************
...
target_translation_ev = 'Spanish to English'

#SET THE MODEL PARAMETERS
model_name = language_models_df.loc[language_models_df['Language'] == target_translation_ev, 'Model_Name'].values[0]
tokenizer = MarianTokenizer.from_pretrained(model_name)
model = MarianMTModel.from_pretrained(model_name)
...
print(f"Translated text exported to TXT file: {txt_file_path}")
